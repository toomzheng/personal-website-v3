      ...
      {socialLinks.map((social, index) => {
        ...
        return (
          <motion.a
            ...
            className={`text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors absolute ${isStarted ? '' : 'position-initial'
              }`}
            initial={false}
            animate={{
              x: getPosition().x,
